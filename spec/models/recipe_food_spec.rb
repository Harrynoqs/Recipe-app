...
RSpec.describe RecipeFood, type: :model do
  before(:each) do
    @user = User.create(name: 'Harry', email: 'harry@gmail.com', password: 'noqs123')
    @food = Food.create(name: 'peas', measurement_unit: 'kg', price: 200, quantity: 2, user_id: @user.id)
    @recipe = Recipe.create(name: 'peas soup', description: 'vegeterian food',
